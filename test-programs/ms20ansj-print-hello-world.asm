...
; ```
; asl -cpu 1802 -L print-hello-world.asm
; p2hex print-hello-world.p print-hello-world.hex
; ```
; -----------------------------------------------------------------------------
...
RE	EQU	14
	...
	; initialize R4 to 8ADAH and R5 to 8AECH to enable SCRT
	LDI	0x8A			; load 
	PHI	R4
	PHI	R5
	LDI	0xDB
